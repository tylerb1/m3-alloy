...
export default function DidYouKnow() {
  return (
    <div className={`
      ...
      lg:to-35%
    `}>
      <div className="did-you-know-content flex flex-col lg:gap-12 lg:flex-row-reverse p-12 lg:px-16 lg:py-20 justify-around items-center">
        ...
        <div className="did-you-know-info text-center max-w-[40rem] pt-8 lg:pt-0 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start lg:ml-[25%] mt-4 lg:mt-8">
